...
// Your implementation here!
conn.query("CREATE TABLE zipcodes (zipcode TEXT, city TEXT, state TEXT);", function() {
    console.log("I MADE THE TABLE");
});
 
zipcoder('some_zipcodes.csv', function(region){
    conn.query("INSERT INTO zipcodes VALUES ($1, $2, $3);", [region.zipcode, region.city, region.state],
        function() { console.log("Inserted " + region.city); });
});
/*
...
NYC's zipcodes (10001 and so on) is defined in both.
